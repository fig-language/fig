...
This document provides an overview of array-based collections in the Nyx programming language, focusing on syntax, indexing, iteration, and standard operations.
...
* Strings are **not a built-in type** in Nyx; they will be provided by the standard library.
...
* Arrays are the only built-in aggregate collection in Nyx at the bootstrapping stage.
...
This document summarizes **arrays and collection-like behavior in Nyx**, providing developers with syntax, examples, and expected behavior for literals, indexing, iteration, and standard operations, while clarifying that strings are part of the standard library and built on arrays.
